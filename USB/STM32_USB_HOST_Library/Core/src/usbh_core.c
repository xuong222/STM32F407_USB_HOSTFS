...
void USBH_Process(USB_OTG_CORE_HANDLE *pdev , USBH_HOST *phost)
{
  ...
  case HOST_DEV_ATTACHED :	//�ղ��ϣ��������ͨ�� + �˿ڸ�λ
  ...
  case HOST_ENUMERATION:     //�ÿ��ƴ������ USB �豸��ö�١�
    /* USBH_HandleEnum() ��һ��С״̬�������水 USB Э��˳������
		-��ǰ 8 �ֽ��豸���������õ� EP0 ��������
		-�������豸��������VID��PID �ȣ�
		-SET_ADDRESS ���豸�����ַ
		-���������������ӿڡ��˵�ȣ�
...
USBH_Status USBH_HandleControl (USB_OTG_CORE_HANDLE *pdev, USBH_HOST *phost)
{
  ...
  case CTRL_SETUP_WAIT:
    ...
    else if ((HCD_GetCurrentFrame(pdev) - phost->Control.timer) > NODATA_STAGE_TIMEOUT)
    {
      phost->Control.state = CTRL_ERROR;
